        ...
        <div className="container mx-auto px-4 md:px-6 py-8 md:py-12 relative z-10">
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start md:items-center">
            ...
            <div className="flex-1 space-y-4">
              <div>
                {(designSettings?.storeName || "Turn your X account into a money making machine") && (
                  <p className="text-sm text-muted-foreground mb-2">{designSettings?.storeName || "Turn your X account into a money making machine"}</p>
                )}
