    ...
    <div className="space-y-6 sm:space-y-8 animate-fade-in">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-4 sm:p-6 text-center">
              <div className="text-2xl sm:text-3xl font-semibold text-fg mb-1">{tutors.length}</div>
          ...
          <Card className="border-border/50 bg-card/50 backdrop-blur-sm">
            <CardContent className="p-4 sm:p-6 text-center">
              <div className="text-2xl sm:text-3xl font-semibold text-fg mb-1">{totalStudents}</div>
      ...
      {tutors.length > 0 && (
        <div className="space-y-4 sm:space-y-6">
          <h2 className="text-xl sm:text-2xl font-semibold text-fg">Your Tutors</h2>
                ...
                <CardContent className="p-4 sm:p-6 space-y-4">
                  <div className="flex items-start justify-between">
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-fgMuted text-sm truncate">{tutor.subject}</p>
                    </div>
                    <div className={`w-3 h-3 rounded-full flex-shrink-0 ml-2 ${tutor.status === 'active' ? 'bg-green-500' : 'bg-gray-400'}`} />
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-border/50">
                    <div className="text-center">
                      <div className="flex items-center justify-center mb-1">
                        ...
                        <span className="font-semibold text-fg text-sm sm:text-base">{tutor.students}</span>
                      </div>
                    ...
                    <div className="text-center">
                      <div className="flex items-center justify-center mb-1">
                        ...
                        <span className="font-semibold text-fg text-sm sm:text-base">{tutor.conversations}</span>
                      </div>
