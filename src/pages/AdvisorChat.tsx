...
import { Bot, Settings, Menu, AlertCircle } from "lucide-react";
      ...
      <div className="h-screen flex flex-col">
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-base text-muted-foreground">Connecting to your advisor...</p>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <h3 className="font-semibold text-xl mb-3">Advisor Not Available</h3>
          <p className="text-base text-muted-foreground">
            {error || "This advisor is not available for conversation."}
          </p>
        </div>
      </div>
    );
    ...
    <div className="h-screen flex flex-col">
      ...
      <Alert className="mx-6 mt-4 border-yellow-200 bg-yellow-50">
        ...
        <AlertDescription className="text-yellow-800">
          This AI persona is fictional and unaffiliated with {agent.name}. 
          Based on public lectures, books, and interviews.
        </AlertDescription>
      </Alert>
        ...
        <div className="flex-1 overflow-y-auto">
          {allMessages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center px-6">
              ...
              <h2 className="text-2xl font-semibold mb-3">How can I guide you today?</h2>
              <p className="text-base text-muted-foreground text-center max-w-md leading-relaxed">
                {realtimeChat.connectionStatus === 'connecting' 
                  ...
                  : `I'm here as ${agent.name} to share insights and wisdom with you.`
                }
              </p>
            </div>
          ) : (
