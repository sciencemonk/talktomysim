      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {isLoading ?
          ...
          Array.from({ length: 6 }).map((_, i) => (
            ...
            <Card 
              key={tutor.id} 
              className="cursor-pointer hover:shadow-md transition-all duration-200 border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 h-full" 
