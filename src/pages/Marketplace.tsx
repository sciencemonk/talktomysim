...
const Marketplace = () => {
  ...
  return <div className="min-h-screen bg-bg">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          ...
          <CardContent className="p-6">
            <div className="flex flex-col gap-4">
              <div className="relative flex-1">
                ...
                <Input placeholder="Search for AI agents, products, and digital goods..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)} className="pl-10 h-12 text-base bg-inputBg border-inputBorder" />
              </div>
              
              {/* Category Tabs */}
              <div className="flex flex-wrap gap-2">
                <Button variant={categoryFilter === "all" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("all")} className="gap-2">
                  All
                </Button>
                <Button variant={categoryFilter === "x402 Agents" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("x402 Agents")} className="gap-2">
                  <Sparkles className="h-4 w-4" />
                  x402 Agents
                </Button>
                <Button variant={categoryFilter === "MCP Servers" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("MCP Servers")} className="gap-2">
                  <Bot className="h-4 w-4" />
                  MCP Servers
                </Button>
                <Button variant={categoryFilter === "Chatbots" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("Chatbots")} className="gap-2">
                  <Bot className="h-4 w-4" />
                  Chatbots
                </Button>
                <Button variant={categoryFilter === "Products" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("Products")} className="gap-2">
                  <Package className="h-4 w-4" />
                  Products
                </Button>
                <Button variant={categoryFilter === "nft" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("nft")} className="gap-2">
                  <FileText className="h-4 w-4" />
                  NFT
                </Button>
                <Button variant={categoryFilter === "PumpFun Agents" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("PumpFun Agents")} className="gap-2">
                  <Zap className="h-4 w-4" />
                  PumpFun Agents
                </Button>
                <Button variant={categoryFilter === "Stores" ? "default" : "outline"} size="sm" onClick={() => setCategoryFilter("Stores")} className="gap-2">
        ...
        {agentsLoading ? <div className="mb-12">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              {Array.from({
            length: 12
          }).map((_, i) => <Card key={i} className="animate-pulse border-border">
            ...
            {/* x402 Agents Section */}
            {(categoryFilter === 'all' || categoryFilter === 'x402 Agents') && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                ...
                {filteredAgents.filter(a => (a as any).sim_category === 'x402 Agent').length > 0 ? <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                    {filteredAgents.filter(a => (a as any).sim_category === 'x402 Agent').map(agent => {
              const getAvatarSrc = () => {
              ...
              return <Card key={agent.id} className="group cursor-pointer border-border bg-card hover:shadow-lg hover:border-primary/30 transition-all duration-300 hover:-translate-y-1" onClick={() => handleItemClick({
                id: agent.id,
                type: 'agent',
                name: agent.name,
                description: agent.description,
                ...
                sales: agent.interactions || 0
                            ...
                            <div className="relative w-full aspect-[4/3] overflow-hidden bg-muted rounded-t-lg">
                              <Avatar className="w-full h-full rounded-none">
                                <AvatarImage src={getAvatarSrc()} alt={agent.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" referrerPolicy="no-referrer" crossOrigin="anonymous" />
                  ...
                  </div> : <Card className="border-border bg-card">
            ...
            {/* MCP Servers Section */}
            {(categoryFilter === 'all' || categoryFilter === 'MCP Servers') && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                ...
                {filteredAgents.filter(a => (a as any).sim_category === 'MCP Server').length > 0 ? <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                    {filteredAgents.filter(a => (a as any).sim_category === 'MCP Server').map(agent => {
              const getAvatarSrc = () => {
                const avatarUrl = agent.avatar_url || agent.avatar;
                if (avatarUrl && (avatarUrl.startsWith('http://') || avatarUrl.startsWith('https://'))) {
                  return `https://images.weserv.nl/?url=${encodeURIComponent(avatarUrl)}`;
            ...
            {/* Chatbots Section */}
            {(categoryFilter === 'all' || categoryFilter === 'Chatbots') && filteredAgents.filter(a => (!(a as any).sim_category || (a as any).sim_category === 'Chat') && (a as any).marketplace_category !== 'nft').length > 0 && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                      <Bot className="h-6 w-6" />
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                  {filteredAgents.filter(a => (!(a as any).sim_category || (a as any).sim_category === 'Chat') && (a as any).marketplace_category !== 'nft').sort((a, b) => {
                ...
                badge: agent.is_verified ? 'Verified' : agent.is_featured ? 'Featured' : undefined
                          ...
                          <CardContent className="p-3 space-y-2">
                            <div className="flex items-center justify-between gap-2">
                              ...
                              {agent.is_verified && <Badge className="text-xs bg-brandPurple text-white shrink-0">
            ...
            {/* NFTs Section */}
            {(categoryFilter === 'all' || categoryFilter === 'nft') && filteredAgents.filter(a => (a as any).marketplace_category === 'nft').length > 0 && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                  {filteredAgents.filter(a => (a as any).marketplace_category === 'nft').sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map(agent => {
              const getAvatarSrc = () => {
                const avatarUrl = agent.avatar_url || agent.avatar;
                if (avatarUrl && (avatarUrl.startsWith('http://') || avatarUrl.startsWith('https://'))) {
                  return `https://images.weserv.nl/?url=${encodeURIComponent(avatarUrl)}`;
            ...
            {(categoryFilter === 'all' || categoryFilter === 'PumpFun Agents') && filteredAgents.filter(a => (a as any).sim_category === 'PumpFun Agent').length > 0 && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                  {filteredAgents.filter(a => (a as any).sim_category === 'PumpFun Agent').sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime()).map(agent => {
              const getAvatarSrc = () => {
                const avatarUrl = agent.avatar_url || agent.avatar;
                if (avatarUrl && (avatarUrl.startsWith('http://') || avatarUrl.startsWith('https://'))) {
                  return `https://images.weserv.nl/?url=${encodeURIComponent(avatarUrl)}`;
            ...
            {(categoryFilter === 'all' || categoryFilter === 'nft') && filteredAgents.filter(a => (a as any).sim_category === 'NFT').length > 0 && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                ...
                {filteredAgents.filter(a => (a as any).sim_category === 'NFT').length > 0 ? <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
                    {filteredAgents.filter(a => (a as any).sim_category === 'NFT').map(agent => {
              ...
              return <Card key={agent.id} className="group cursor-pointer border-border bg-card hover:shadow-lg hover:border-primary/30 transition-all duration-300 hover:-translate-y-1" onClick={() => handleItemClick({
                ...
                sales: 0
                            ...
                            <div className="relative w-full aspect-square overflow-hidden bg-muted rounded-t-lg">
                              <Avatar className="w-full h-full rounded-none">
                                <AvatarImage src={agent.avatar_url || agent.avatar} alt={agent.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-300" />
                                <AvatarFallback className="w-full h-full rounded-none bg-primary/10 flex items-center justify-center">
                                  <FileText className="h-8 w-8 text-primary" />
                                </AvatarFallback>
                              </Avatar>
                              {socialLinks?.symbol && <Badge className="absolute top-2 right-2 bg-primary text-primary-foreground text-xs">
                                  {socialLinks.symbol}
                                </Badge>}
                            </div>
                            <CardContent className="p-3 space-y-2">
                              ...
                              {socialLinks?.supply && <div className="pt-1 border-t border-border/50">
            ...
            {/* Stores Section */}
            {(categoryFilter === 'all' || categoryFilter === 'Stores') && filteredAgents.filter(a => (a as any).sim_category === 'Crypto Mail').length > 0 && <div className="mb-12">
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h2 className="text-2xl font-bold text-fg mb-2 flex items-center gap-2">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                  {filteredAgents.filter(a => (a as any).sim_category === 'Crypto Mail').sort((a, b) => {
              if (a.is_verified && !b.is_verified) return -1;
              if (!a.is_verified && b.is_verified) return 1;
              return new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime();
            }).map(agent => {
        ...
        {categoryFilter !== 'Stores' && categoryFilter !== 'NFT' && categoryFilter !== 'nft' && categoryFilter !== 'Chatbots' && categoryFilter !== 'PumpFun Agents' && categoryFilter !== 'MCP Servers' && categoryFilter !== 'x402 Agents' && <>
            <div className="mb-6">
          ...
          Array.from({
            length: 8
          }).map((_, i) => <Card key={i} className="animate-pulse border-border overflow-hidden">
              ...
              </Card>) : filteredItems.map((item, index) => <Card key={item.id} className="group cursor-pointer overflow-hidden border border-border bg-card hover:shadow-2xl transition-all duration-300 hover:-translate-y-1" onClick={() => handleItemClick(item)}>
                <CardContent className="p-0">
                  {/* Product Image */}
                  <div className="relative aspect-square overflow-hidden">
                    {item.avatar ? <img src={item.avatar} alt={item.name} className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-500" /> : <div className={`w-full h-full flex items-center justify-center bg-gradient-to-br ${getGradientForItem(index)} group-hover:scale-105 transition-transform duration-500`}>
                        {item.type === 'agent' ? <Bot className="h-16 w-16 text-primary/60" /> : <Package className="h-16 w-16 text-primary/60" />}
                      </div>}
                    
                    {/* Badge */}
                    {item.badge && <Badge className="absolute top-3 right-3 bg-primary text-primary-foreground shadow-lg">
                  ...
                  <div className="p-4">
                    ...
                    {/* Rating and Sales */}
                    {(item.rating > 0 || item.sales > 0) && <div className="flex items-center gap-3 mb-3 text-xs text-fgMuted border-t border-border pt-3">
                        {item.rating > 0 && <div className="flex items-center gap-1">
                            <Star className="h-3.5 w-3.5 fill-yellow-500 text-yellow-500" />
                            <span className="font-medium">{item.rating.toFixed(1)}</span>
                          </div>}
                        {item.sales > 0 && <div className="flex items-center gap-1">
                    ...
                    <div className="flex justify-between items-center">
                      {item.price !== undefined && item.price > 0 ? <p className="text-xl font-bold text-primary">
                          {item.price.toFixed(2)} USDC
                        </p> : <Badge variant="secondary" className="text-sm font-semibold">Free</Badge>}
                    </div>
                  </div>
                </CardContent>
              </Card>)}
            ...
            {filteredItems.length === 0 && !isLoading && <Card className="border-border bg-card">
            <CardContent className="text-center py-12">
              <div className="bg-bgMuted p-4 rounded-full w-16 h-16 mx-auto mb-4 flex items-center justify-center">
