                ...
                <CardContent>
                  ...
                  <TabsContent value="links" className="space-y-4">
                    <div className="space-y-2">
                      ...
                      {agent.social_links && typeof agent.social_links === 'object' && (
                        <>
                          {(agent.social_links as any).twitter && (
                            <Button
                              variant="outline"
                              className="w-full justify-between"
                              onClick={() => window.open((agent.social_links as any).twitter, '_blank')}
                            >
                          ...
                          {(agent.social_links as any).website && (
                            <Button
                              variant="outline"
                              className="w-full justify-between"
                              onClick={() => window.open((agent.social_links as any).website, '_blank')}
                            >
                              <span className="flex items-center gap-2">
                                <ExternalLink className="h-4 w-4" />
                                Website
                          ...
                          {(agent.social_links as any).telegram && (
                            <Button
                              variant="outline"
                              className="w-full justify-between"
                              onClick={() => window.open((agent.social_links as any).telegram, '_blank')}
                            >
                              <span className="flex items-center gap-2">
                                <svg className="h-4 w-4" viewBox="0 0 24 24" fill="currentColor">
