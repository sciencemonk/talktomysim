...
const TeacherDashboard = () => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Welcome Section */}
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-8 border border-blue-100 dark:border-blue-900">
        <div className="max-w-3xl">
          <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-2">
            Welcome to Your Teaching Hub
          </h1>
          <p className="text-gray-600 dark:text-gray-400 mb-6 leading-relaxed">
            Create and manage AI tutors to help your students learn more effectively. Each tutor is designed to provide personalized support aligned with your teaching objectives.
          </p>
