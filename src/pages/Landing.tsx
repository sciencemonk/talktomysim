...
const Landing = () => {
  ...
  return <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6" style={{
    backgroundColor: '#cfff3e'
      ...
      <div className="text-center max-w-5xl mx-auto">
        ...
        <div className="mb-8 sm:mb-12 lg:mb-16">
          <button onClick={handleLogIn} className="text-black/70 hover:text-black text-sm sm:text-base font-medium transition-colors">
