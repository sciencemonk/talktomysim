            ...
            <Card className="shadow-lg border border-gray-100">
              <CardHeader className="pb-4 bg-gray-50/50">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-gray-900">Student Usage Analytics</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="bg-white">
                <div className="space-y-4">
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
                    <span className="text-sm font-medium text-gray-700">Math Tutor</span>
                    <span className="text-sm text-green-600 font-semibold">145 interactions</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
                    <span className="text-sm font-medium text-gray-700">Science Helper</span>
                    <span className="text-sm text-green-600 font-semibold">89 interactions</span>
                  </div>
                  <div className="flex justify-between items-center p-3 bg-gray-50 rounded-lg border">
                    <span className="text-sm font-medium text-gray-700">Writing Assistant</span>
                    <span className="text-sm text-green-600 font-semibold">67 interactions</span>
                  </div>
                  <div className="mt-4 p-3 bg-brandPurple/10 rounded-lg border border-brandPurple/20">
            ...
            <Card className="shadow-lg border border-gray-100">
              <CardHeader className="pb-4 bg-gray-50/50">
                <div className="flex items-center gap-2">
                  ...
                  <CardTitle className="text-lg text-gray-900">Tutor Customization</CardTitle>
                </div>
              </CardHeader>
              <CardContent className="bg-white">
                <div className="space-y-4">
                  ...
                  <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border">
                    ...
                    <span className="text-sm text-gray-700">Real-time feedback enabled</span>
                  </div>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-16 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {/* Free Plan */}
            <Card className="relative shadow-lg border-2 border-gray-200 bg-white">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-700">Up to 3 AI tutors</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                ...
                <Button className="w-full mt-6 bg-gray-800 hover:bg-gray-700" variant="default">
                  Get Started Free
                </Button>
              </CardContent>
            </Card>
            ...
            {/* Pro Plan - 8 Tutors */}
            <Card className="relative shadow-lg border-2 border-brandPurple bg-white">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">Up to 8 AI tutors</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">Custom tutor personalities</span>
                  </li>
                </ul>
            ...
            <Card className="relative shadow-lg border-2 border-gray-200 bg-white">
              ...
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">Up to 20 AI tutors</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">Advanced analytics</span>
                  ...
                  <li className="flex items-center gap-2">
                    <Check className="h-4 w-4 text-green-600" />
                    <span className="text-sm text-gray-700">Bulk student management</span>
                  </li>
                </ul>
                <Button className="w-full mt-6 bg-gray-800 hover:bg-gray-700" variant="default">
                  Start Pro Plus
