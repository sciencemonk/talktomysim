...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      "flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm text-gray-900 outline-none focus:bg-gray-100 data-[state=open]:bg-gray-100",
      inset && "pl-8",
      className
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto text-xs tracking-widest text-gray-600 opacity-60", className)}
      {...props}
    />
  )
}
