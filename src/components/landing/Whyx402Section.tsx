    ...
    <section className="container mx-auto px-3 sm:px-4 py-16 border-b">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-lg text-muted-foreground mb-8 text-center max-w-3xl mx-auto">
          x402 is an HTTP status code designed for per-request payments, enabling seamless micropayments without traditional payment infrastructure. Accepting payments online has traditionally meant forcing users into accounts, managing API keys, and handling manual billing cycles. x402 removes these barriers by offering:
        </p>
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-12">
          <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-xl bg-card border-2 border-border hover:border-[#83f1aa] transition-all duration-300">
            ...
            <p className="text-sm text-muted-foreground">
              No subscriptions, no prepayments, no lock-in. Pay only for what you use.
            </p>
          </div>
          ...
          <div className="flex flex-col items-center text-center space-y-3 p-6 rounded-xl bg-card border-2 border-border hover:border-[#83f1aa] transition-all duration-300">
            ...
            <p className="text-sm text-muted-foreground">
              No chargebacks, no fraud risks, no intermediaries. Payments are final and instant.
            </p>
          </div>
